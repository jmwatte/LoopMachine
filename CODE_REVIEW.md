...
|---|------|-------------|---------------|
| 1 | Toon `_large_file_warning` in statusbalk i.p.v. weggooien | `waveform.rs:159-166` | 5 min |
| 2 | Toon `short_id` in loop-lijst (`(a) NaamLoop` formaat) | `app.rs:2377-2391`, `app.rs:2598-2608` | 10 min |
...
| # | Item | Bestand(en) | Geschatte tijd |
|---|------|-------------|---------------|
| 5 | Fix `waveform_has_content` — zet op `true` na succesvolle `load_file` | `app.rs:309` | 5 min |
