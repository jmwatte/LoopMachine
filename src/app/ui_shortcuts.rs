            ...
            .show(ctx, |ui| {
                egui::ScrollArea::vertical().show(ui, |ui| {
                    ui.vertical(|ui| {
                        ...
                        use crate::shortcuts::ShortcutAction;
                        let categories = ["Playback", "Loop", "Markers", "View", "File", "Edit"];
                        ...
                        shortcut_row(ui, "Dubbelklik", "Toggle Section marker");
                        shortcut_row(ui, "Shift+Dubbelklik", "Toggle Measure marker");
                        shortcut_row(ui, "Ctrl+Dubbelklik", "Toggle Beat marker");
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.with_layout(
                                ...
                                |ui| {
                                    ...
                                    let is_listening = self.listening_for_action == Some(*action);
                                    let btn_text = if is_listening {
                                        RichText::new("... druk toets ...").color(Color32::YELLOW)
                                    } else {
